...
@AndroidEntryPoint
class KeroseneFragment : BaseFragment<FragmentOilAvgBinding>(R.layout.fragment_oil_avg) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.oilKind.text = getString(R.string.kerosene)
        binding.oilAvgRecyclerView.adapter = oilAvgAdapter
        setupChart()
        observeViewModel()
        oilAvgViewModel.fetchOilAvg(getString(R.string.kerosene_code))
    }
