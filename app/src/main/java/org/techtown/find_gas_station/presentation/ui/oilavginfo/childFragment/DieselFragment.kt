...
class DieselFragment(private val oilAvgViewModel : OilAvgViewModel): BaseFragment<FragmentOilAvgBinding>(R.layout.fragment_oil_avg) {
    ...
    private fun setOilAvgViewCreated() {
        OilAvgViewCreated.setupOilChartAndRecycler(
            requireContext().getString(R.string.diesel_oil),
            requireContext(),
            binding,
            oilAvgViewModel,
